  ...
  data() {
    return {
      ...
      images: [
        ...
        { src: require('@/pictures/page1/about_top.jpg'), info: '群号：234567', topLeftInfo: '图2信息' },
        { src: require('@/pictures/page1/about_top.jpg'), info: '群号：345678', topLeftInfo: '图3信息' },
        { src: require('@/pictures/page1/about_top.jpg'), info: '群号：456789', topLeftInfo: '图4信息' },
        { src: require('@/pictures/page1/about_top.jpg'), info: '群号：567890', topLeftInfo: '图5信息' },
        { src: require('@/pictures/page1/about_top.jpg'), info: '群号：678901', topLeftInfo: '图6信息' },
        { src: require('@/pictures/page1/about_top.jpg'), info: '群号：789012', topLeftInfo: '图7信息' },
